...
import se.admin.service.ContractService;
import se.admin.service.EmployeeService;
import se.admin.validator.ContractValidator;
import se.admin.validator.EmployeeValidator;
import se.model.*;
...
public class EmployeeController extends ShopController {
	...
	public String formReset(ModelMap model, @PathVariable(value = "id") String id,
		...
		employee.setPassword("123" + new Date().getDate() + new Date().getMonth() + new Date().getYear());
		employeeService.editEmployee(employee);
