...
<div id="sidebar" class="span3">
	<div class="well well-small">
		<a id="myCart" href="shopping-cart/index"><img
			src="themes/images/ico-cart1.png" alt="cart">Xem sản phẩm giỏ
			hàng </a><br> <br> 
			<span id="cart-amount"  style="color: blue"
			class="btn btn-warning pull-right"><fmt:formatNumber 
				value="${cart.amount}" pattern="###,###" /> VNĐ</span> 
				
			<span id="cart-count"  class="btn btn-warning pull-left" style="color: blue">${cart.count}
			Sản phẩm</span> <br> <br>
	</div>
		...
		<c:when test="${sessionScope.user.fullName != null}">
			<div class="well well-small">
				<a id="myCart" href="order/checkout"><img
					src="themes/images/ico-cart1.png" alt="cart">Đơn đặt hàng </a><br>
				<a id="myCart" href="order/list"><img
					src="themes/images/ico-cart1.png" alt="cart">Thông tin đơn
					hàng </a><br> <a id="myCart" href="order/product"><img
					src="themes/images/ico-cart1.png" alt="cart">Sản phẩm đã mua </a><br>
			</div>
		</c:when>
	</c:choose>
	...
	<ul class="nav nav-tabs nav-stacked">
		<li class="subMenu open"><a> LOẠI SẢN PHẨM</a>
			<ul>
				<!-- Show Danh Mục -->
